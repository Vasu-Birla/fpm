...
<head>
    ...
    <title>Forgot Password || eLaw Lawyer</title>
			...
			<div class="w-100 overflow-hidden position-relative flex-wrap d-block vh-100">
				...
				<div class="row justify-content-center align-items-center vh-100 overflow-auto flex-wrap">
					<div class="col-lg-4 mx-auto">
						<form action="email-verification.php" class="d-flex justify-content-center align-items-center" method="POST">
								...
								<div class="card border-1 p-lg-3 shadow-md rounded-3 mb-4">
									<div class="card-body">
										...
										<div class="mb-3">
											...
											<div for="email" class="input-group">
										...
										<div class="mb-3">
											<button type="submit" name="submit" id="submit" class="btn bg-primary text-white w-100">Reset Password </button>
										</div>
