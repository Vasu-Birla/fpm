    ...
    <div class="content">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <!-- page header start -->
                <div class="mb-4">
                    <h6 class="fw-bold mb-0 d-flex align-items-center"> <a href="firmstaff-list.php" class="text-dark"> <i class="ti ti-chevron-left me-1"></i>Add Firm User</a></h6>
                </div>
                <!-- page header end -->
                ...
                <form action="#" method="POST">
                    ...
                    <div class="d-flex align-items-center justify-content-end">
                        ...
                        <button type="submit" name="submit"  class="btn btn-primary btn-md fs-13 fw-medium rounded">Save User</button>
                    </div>
                </form>
