      ...
      <div class="col-lg-12">
        ...
        <div class="mb-4">
          <h5 class="fw-bold mb-0 d-flex align-items-center">
            <a href="legaldrafting-list.php" class="text-dark">
              <i class="ti ti-chevron-left me-1"></i>Edit Legal Drafting Form
            </a>
          </h5>
        </div>
        <!-- page header end -->
        ...
        <form action="#" method="POST">
          ...
          <div class="d-flex align-items-center justify-content-end">
            ...
            <button type="submit" name="submit" class="btn btn-primary btn-md fs-13 fw-medium rounded">Update Document</button>
          </div>
