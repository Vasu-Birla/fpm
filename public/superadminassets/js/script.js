/*
Author       : CyberImpulse
Template Name: Rental car - Bootstrap Admin Template
*/
...
(function () {
	...
	// Sidebar Initiate
	init();
	// Remove sidebar hover auto-expand/collapse logic to prevent sidebar from closing on mouseout after toggle button click
	...
	$(document).on('click', '#toggle_btn', function () {
		...
		if (!$body.hasClass('mini-sidebar')) {
			...
			// Change icon to right arrow (open)
			if ($icon.length) $icon.removeClass('ti-arrow-left').addClass('ti-arrow-right');
		} else {
			$body.removeClass('mini-sidebar');
			$(this).addClass('active');
			// Change icon to left arrow (close)
			if ($icon.length) $icon.removeClass('ti-arrow-right').addClass('ti-arrow-left');
		}

		// Full-width layout handle
		if (isFullWidth) {
